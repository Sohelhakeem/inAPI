...
public class inVC_SettingPage extends BaseClass {
	...
	public void tc1() throws InterruptedException {
		...
		String actualUrl="https://staging.invc.vc/?redirect=/settings";
...
//	        String actualErrorMsg = exp.getText();
	...
	//Verifying the functionality of headerAvatarDrpDwn Setting Current Password by entering Wrong Current Password Password.
	@Test
...
//	        String actualErrorMsg = exp.getText();
	...
	public void  tc6() throws InterruptedException {
		...
		String expectedurl = "https://staging.invc.vc/?redirect=/manage-licenses";
		String currenturl = driver.getCurrentUrl();
		Assert.assertEquals(expectedurl, currenturl);
